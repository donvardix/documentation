            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                          <label for="gender" class="col-md-4 col-form-label text-md-right">{{ __('Ваш пол') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select class="form-control col-md-3 d-inline" id="birthday_d" name="birthday_d">
                                @for ($i = 1; $i <= 31; $i++)
                                  <option>@if ($i<=9)0{{ $i }}@else{{ $i }}@endif</option>
                                @endfor
                              </select>
                              <select class="form-control col-md-4 d-inline" id="birthday_m" name="birthday_m">
                                @for ($i = 1; $i <= 12; $i++)
                                  <option>@if ($i<=9)0{{ $i }}@else{{ $i }}@endif</option>
                                @endfor
                              </select>
                              <select class="form-control col-md-4 d-inline" id="birthday_y" name="birthday_y">
                                @for ($i = 1900; $i <= 2019; $i++)
                                  <option>{{ $i }}</option>
                                @endfor
                              </select>
