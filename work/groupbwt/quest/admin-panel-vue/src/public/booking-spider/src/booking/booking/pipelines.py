...
from booking.models import db_connect, Hotels, Rooms, Variants, Parsers
...
class BookingPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        parsers = Parsers()
        parsers.hotel_id = hotel.id
        parsers.user_id = item["user_id"]
        parsers.created_at = item["created_at"]
        parsers.updated_at = item["updated_at"]
